      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('admin.getDepartments')}}" class="nav-link {{ (request()->segment(2) == 'departments') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Departments</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{route('admin.holiay')}}" class="nav-link {{ (request()->segment(2) == 'holiday') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Holiday</p>
                </a>
              </li>
